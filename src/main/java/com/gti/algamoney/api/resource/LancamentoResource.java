...
import com.gti.algamoney.api.exceptionhandler.AlgamoneyExceptionHandler.Erro;
...
import com.gti.algamoney.api.service.LancamentoService;
...
public class LancamentoResource {
	...
	@GetMapping(params = "resumo") // se tiver paramentro com o nome 'resumo' direciona para este metodo
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO') and #oauth2.hasScope('read')")
	...
	public ResponseEntity<Lancamento> criar(@Valid @RequestBody Lancamento lancamento, HttpServletResponse response) {
		...
		// Evento lançado para a inclusão do Header "Location" na requisição
